...
| :--- | :--- | :--- | :--- |
| **Phase 1** | Khởi Tạo & Core Logic | `[ ]` | Xây dựng khung nền móng và các logic cốt lõi. |
| **Phase 2** | UI/UX & Tính năng chính | `[ ]` | Phát triển các giao diện người dùng chính và kết nối dữ liệu. |
...
- **Các task chính:**
  - [ ] Thiết lập dự án mới, cài đặt thư viện cần thiết.
  - [ ] Khởi tạo cấu trúc store quản lý state chính.
  - [ ] Viết các service kết nối API / Xử lý nghiệp vụ nền tảng.
...
- **Các task chính:**
  - [ ] Tạo layout chính của ứng dụng (Header, Sidebar, Footer, Responsive).
  - [ ] Xây dựng các trang chính và kết nối với State Store.
  - [ ] Áp dụng các hiệu ứng animation (như Framer Motion) để tăng độ mượt mà.
